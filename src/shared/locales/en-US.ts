export const EN_US_MESSAGES = {
    "passkey.retry": "Retry",
    "passkey.sign_in": "Sign in with a passkey",
    "passkey.title": "Passkeys",
    "passkey.description": "Sign in with your face, fingerprint, device PIN or security key. Add up to 10 passkeys.",
    "passkey.disabled": "Passkeys are unavailable on this instance and in demo mode.",
    "passkey.add": "Add passkey",
    "passkey.rename": "Rename",
    "passkey.delete": "Delete",
    "passkey.name_placeholder": "e.g. My iPhone or security key",
    "passkey.password_placeholder": "Enter your current password",
    "passkey.code_placeholder": "Enter a 6-digit code or recovery code",
    "passkey.name": "Passkey name",
    "passkey.created": "Created {date}",
    "passkey.last_used": "Last used: {date}",
    "passkey.never_used": "Not used to sign in yet",
    "passkey.delete_description": "Deleting “{name}” prevents sign-in with this passkey. Its entry in your password manager will remain.",
    "passkey.code": "Authenticator or recovery code",
    "passkey.reauth": "Verify your identity to continue. Other sessions will be signed out after success. Recovery codes can only be used once, even if you cancel afterward.",
    "passkey.confirm": "Confirm",
    "passkey.cancel": "Cancel",
    "passkey.sessions_revoked": "Passkeys updated. Other sessions have been signed out.",
    "passkey.recovery_note": "If your device is unavailable, use your password and enabled two-step verification. Passkeys cannot reset a forgotten password and are not included in note exports. Register again after changing domains.",
    "passkey.offline": "Connect to the internet to use passkeys.",
    "passkey.unsupported": "Passkeys require a supported browser and a secure connection.",
    "passkey.not_completed": "Passkey operation was not completed. It may have been canceled, timed out, or found no available passkey. Try again or use your password.",
    "passkey.duplicate": "This passkey is already registered. Choose another one.",
    "passkey.failed": "The passkey operation did not succeed. Please try again.",
    "passkey.timeout": "The passkey operation timed out. Please try again.",
    "passkey.invalid": "Unable to verify this passkey. Try again or sign in with your password.",
    "passkey.expired": "The verification expired or account credentials changed. Please start again.",
