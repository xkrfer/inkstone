...
export const ZH_CN_MESSAGES = {
    "passkey.retry": "重试",
    "passkey.sign_in": "使用通行密钥登录",
    "passkey.title": "通行密钥",
    "passkey.description": "使用面容、指纹、设备 PIN 或安全密钥登录，最多添加 10 个。",
    "passkey.disabled": "此实例尚未启用通行密钥，体验版不支持此功能。",
    "passkey.add": "添加通行密钥",
    "passkey.rename": "重命名",
    "passkey.delete": "删除",
    "passkey.name_placeholder": "例如：我的 iPhone 或安全密钥",
    "passkey.password_placeholder": "请输入当前登录密码",
    "passkey.code_placeholder": "请输入 6 位动态验证码或恢复码",
    "passkey.name": "密钥名称",
    "passkey.created": "创建于 {date}",
    "passkey.last_used": "最近使用：{date}",
    "passkey.never_used": "尚未用于登录",
    "passkey.delete_description": "删除“{name}”后将无法用它登录。系统密码管理器中的条目不会被删除。",
    "passkey.code": "动态验证码或恢复码",
    "passkey.reauth": "此操作需要重新验证身份，完成后会退出其他设备。恢复码仅能使用一次；即使后续操作取消，也不能再次使用。",
    "passkey.confirm": "确认",
    "passkey.cancel": "取消",
    "passkey.sessions_revoked": "已更新通行密钥，其他设备的会话已退出。",
    "passkey.recovery_note": "设备不可用时仍可使用密码和已启用的两步验证。通行密钥不能用于重设忘记的密码，也不会包含在笔记导出中。更换域名后需重新绑定。",
    "passkey.offline": "请连接网络后使用通行密钥。",
    "passkey.unsupported": "当前浏览器或页面不支持通行密钥，请使用安全连接及支持的浏览器。",
    "passkey.not_completed": "通行密钥操作未完成。可能已取消、超时或没有可用密钥，你可以重试或使用密码登录。",
    "passkey.duplicate": "此通行密钥已经添加，请选择其他密钥。",
    "passkey.failed": "通行密钥操作未成功，请重试。",
    "passkey.timeout": "通行密钥操作已超时，请重试。",
    "passkey.invalid": "无法验证通行密钥，请重试或使用密码登录。",
    "passkey.expired": "验证流程已过期或账号凭据已更改，请重新开始。",
